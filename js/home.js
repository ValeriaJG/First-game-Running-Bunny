game.newLoop('home', function () {
  ...
  if (mouse.isInStatic(ui_plus_normal.getStaticBox()) && mouse.isPress("LEFT")) {
    if (ui_plus_hover.file == "img/ui/ui_plus_hover.png") {//при нажатии кнопки будут меняться
      ui_plus_hover.file = "img/ui/ui_minus_hover.png";//замена картинок
      ui_plus_normal.file = "img/ui/ui_minus_normal.png";
      ui_hide_show(true); //видимые кнопки
    } else if (ui_plus_hover.file == "img/ui/ui_minus_hover.png") {
      ui_plus_hover.file = "img/ui/ui_plus_hover.png";
      ui_plus_normal.file = "img/ui/ui_plus_normal.png";
  ...
  if (ui_info_normal.isVisible(true) && mouse.isInStatic(ui_info_normal.getStaticBox()) && mouse.isPress("LEFT")) {
    game.setLoop('specification');
    console.log("22")
  }

  //вкл, выкл музыки
  if (ui_soundOn_normal.isVisible(true) && mouse.isInStatic(ui_soundOn_normal.getStaticBox()) && mouse.isPress("LEFT")) {
    if (ui_soundOn_hover.file == "img/ui/ui_soundOn_hover.png") {
      ui_soundOn_hover.file = "img/ui/ui_soundOff_hover.png";
      ui_soundOn_normal.file = "img/ui/ui_soundOff_normal.png";
      console.log("music off");
    } else if (ui_soundOn_hover.file == "img/ui/ui_soundOff_hover.png") {
      ui_soundOn_hover.file = "img/ui/ui_soundOn_hover.png";
      ui_soundOn_normal.file = "img/ui/ui_soundOn_normal.png";
...
game.setLoop('home'); //цикл лобби
game.start(); //начало будет с лобби