...
var bunny_idle = game.newAnimationObject({
    animation: tiles.newImage("https://worldinformation.ru/game/img/bunny_idle.png").getAnimation(0.3, 0, 189.5, 239, 10),
    x: 100,
    y: 160,
    w: 189.5,
    h: 239,
...
var bunny_down = game.newAnimationObject({
    animation: tiles.newImage("https://worldinformation.ru/game/img/bunny_down.png").getAnimation(0, 0, 188, 208, 7),
    x: 98,
    y: 203,
    w: 188,
    h: 208,
...
var bunny_run = game.newAnimationObject({
    animation: tiles.newImage("https://worldinformation.ru/game/img/bunny_run.png").getAnimation(0, 0, 201.5, 244, 10),
    x: 94,
    y: 170,
    w: 201.5,
    h: 244,
...
var bunny_jump = game.newAnimationObject({
    animation: tiles.newImage("https://worldinformation.ru/game/img/bunny_jump.png").getAnimation(0, 0, 216.53, 255, 15),
    x: 87,
    y: 160,
    w: 216.53,
    h: 255,
...
var bunny_gun_run = game.newAnimationObject({
    animation: tiles.newImage("https://worldinformation.ru/game/img/bunny_gun_run.png").getAnimation(0, 0, 235.5, 244, 6),
    x: 77,
    y: 170,
    w: 235.5,
    h: 244,
...
var bunny_gun_up = game.newAnimationObject({
    animation: tiles.newImage("https://worldinformation.ru/game/img/bunny_gun_up.png").getAnimation(0, 0, 226, 244, 6),
    x: 82,
    y: 170,
    w: 226,
    h: 244,
...
var bunny_double_gun = game.newAnimationObject({
    animation: tiles.newImage("https://worldinformation.ru/game/img/bunny_double_gun.png").getAnimation(0, 0, 235, 244, 10),
    x: 78,
    y: 170,
    w: 235,
    h: 244,
...
var bg_base = game.newImageObject({ //фон
    file: "https://worldinformation.ru/game/img/bg_base.png",
    x: 0,
    y: 0,
    w: 1920,
    h: 1080,
...
var btn_start_normal = game.newImageObject({ //кнопка старт
    file: "https://worldinformation.ru/game/img/ui/play_normal.png",
    x: 450,
    y: 0,
    w: 381,
    h: 98,
...
var btn_start_hover = game.newImageObject({
    file: "https://worldinformation.ru/game/img/ui/play_hover.png",
    x: 450,
    y: 0,
    w: 381,
    h: 98,
...
var hp_frame = game.newImageObject({ //фон для каунтера счета
    file: "https://worldinformation.ru/game/img/hp_frame.png",
    x: 0,
    y: 0,
    w: 327 / 2,
    h: 111 / 1.7
...
var ui_gift_normal = game.newImageObject({ //подарок
    file: "https://worldinformation.ru/game/img/gift.png",
    w: 116 / 2.2,
    h: 111 / 2.2
});
var ui_gift_noactive = game.newImageObject({
    file: "https://worldinformation.ru/game/img/gift_noactive.png",
    w: 116 / 2.2,
    h: 111 / 2.2,
    alpha: 0
});
var gift_hover = game.newImageObject({
    file: "https://worldinformation.ru/game/img/gift_hover.png",
    w: 116 / 2.2,
    h: 111 / 2.2,
    alpha: 0
});
...
var gift_open_anim = game.newAnimationObject({ //анимация открытия подарка
    animation: tiles.newImage("https://worldinformation.ru/game/img/gift_open.png").getAnimation(0, 0, 1506, 1645, 14),
    w: 1974,
    h: 1807,
    x: width / 2 - 590,
    y: height / 2 - 910,
...
var gift_bullet_img = game.newImageObject({ //пуля в подарке
    file: "https://worldinformation.ru/game/img/bullet.png",
    x: width / 2 - 180,
    y: height / 2 - 100,
    w: 154 / 1.5,
    h: 57 / 1.5,
...
var gift_buy_gun_bullet = game.newImageObject({ //пушка в подарке
    file: "https://worldinformation.ru/game/img/buy_gun_bullet.png",
    x: width / 2 + 40,
    y: height / 2 - 70,
    w: 189 / 1.5,
    h: 179 / 1.5,
...
var frame = game.newImageObject({ //фрейм фона магазина
    file: "https://worldinformation.ru/game/img/frame.png",
    w: 1165,
    h: 629
});
...
var specification_gift = game.newImageObject({
    file: "https://worldinformation.ru/game/img/gift.png",
    x: frame.x + 300,
    y: frame.y + 180,
    w: 116 / 1.5,
...
var specification_gun = game.newImageObject({
    file: "https://worldinformation.ru/game/img/buy_gun_bullet.png",
    x: frame.x + 700,
    y: frame.y + 170,
    w: 189 / 1.5,
...
var specification_bullet = game.newImageObject({
...
var specification_coin = game.newImageObject({
    file: "https://worldinformation.ru/game/img/coin.png",
    x: frame.x + 270,
    y: frame.y + 280,
    w: 116 / 1.6,
...
var store_txt = game.newImageObject({ //заголовок магазина
    file: "https://worldinformation.ru/game/img/store_txt.png",
    x: (width / 2) - 104.5,
    y: (height / 2) - 280
});
var specification_txt = game.newImageObject({ //заголовок правил
    file: "https://worldinformation.ru/game/img/specification.png",
    x: (width / 2) - 234.5,
    y: (height / 2) - 280
});
...
var buy_doublegun_bullet = game.newImageObject({
    file: "https://worldinformation.ru/game/img/buy_doublegun_bullet.png"
});
...
function generate_game() { //цыкл подарка, монеты, пуль и преград
    ...
    for (var i = 0; i < 1; i++) {
        ...
        bush.push(
            game.newImageObject({
                file: "https://worldinformation.ru/game/img/bush.png",
                x: bush_dx + width,
    ...
    for (var i = 0; i < 1; i++) {
        ...
        fox.push(
            game.newImageObject({
                file: "https://worldinformation.ru/game/img/fox.png",
                x: bush_dx + width,
                y: 520 - bush_dy,
                w: 233,
                h: 247,
    ...
    for (var i = 0; i < 1; i++) {
        ...
        eagle.push(
            game.newAnimationObject({
                animation: tiles.newImage("https://worldinformation.ru/game/img/eagle.png").getAnimation(0, 0, 488.5, 234, 16),
                x: bush_dx + width,
                y: 290 - bush_dy,
                w: 488.5,
                h: 234,
